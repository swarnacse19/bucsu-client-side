...
const ApplyDistrict = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      try {
        ...
        console.error(err);
        toast.error("Failed to load election details or user status");
      } finally {
        setLoading(false);
      }
    };
  ...
  const handleSubmit = async (e) => {
    ...
    if (!formData.position || !formData.manifesto) {
        ...
        <div className="bg-gradient-to-r from-blue-600 to-blue-700 p-6">
          <div className="flex items-center gap-4">
            ...
            <div className="text-white">
              ...
              <p className="text-blue-100">District Election Candidacy</p>
            </div>
          </div>
        </div>
                ...
                {election?.authorities?.length > 0 ? (
                  election.authorities.map((auth, idx) => (
                    <li key={idx} className="flex items-start gap-2">
                      <span className="text-blue-500 mt-1">•</span> {auth}
                    </li>
                  ))
                ) : (
              ...
              <ul className="space-y-1 text-sm text-slate-600">
                {election?.positions?.length > 0 ? (
                  election.positions.map((pos, idx) => (
                    <li key={idx} className="flex items-start gap-2">
                      <span className="text-blue-500 mt-1">•</span> {pos}
                    </li>
                  ))
                ) : (
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="flex flex-col items-center mb-6">
                <div className="relative">
                  ...
                  <label className="absolute bottom-0 right-0 w-10 h-10 bg-blue-600 text-white rounded-full flex items-center justify-center cursor-pointer hover:bg-blue-700 transition-colors">
                    <FaUpload />
                    <input
                      type="file"
                      accept="image/*"
              ...
              <div>
                ...
                <textarea
                  ...
                  required
                  rows={2}
                  className="w-full px-4 py-3 rounded-xl border border-slate-200 focus:ring-2 focus:ring-blue-500 resize-none"
